...
for (const id of [
  ...
  'maximalist', 'zoomies', 'boing', 'trippy', 'nerd',
  'decompose', 'ouch', 'oops', 'night', 'void',
  'empty-set', 'gallery', 'tempted', 'fibonacci', 'lucas',
  'perfect', 'twinning', 'cousins', 'sexy', 'germain',
  'emirp', 'fermat', 'neat', 'louder', 'smart',
  'balanced', 'stride', 'all-prime', 'super-prime', 'goldbach',
  'collatz', 'run', 'stairs', 'square-up', 'nice',
  'dude', 'meme', 'oil', 'catch', 'route',
  'cards', 'jackpot', 'heinz', 'slurpee', 'sparta',
  'jumbo', 'deck', 'beast', 'angel', 'lucky',
  'unlucky', 'enigma', 'masonic', 'other-beast', 'rest',
